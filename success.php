...
<body>
    <div class="container-xxl bg-white p-0">
		...
		<div  class="modal" style="display:block;">
            <div class="success-box" style="" role="">
				<br>
				<h3>Your application has been successful!
				</h3>
				
				<button type="submit" onclick="location.href ='index.php?application_success'" name="confirm" class="btn  btn-primary" 
				style="border:2px solid rgb(33,36,177);
				width:220px;
				height:40px;
				">Close</button>
            </div>
